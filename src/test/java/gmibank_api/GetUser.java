...
import pojos.gmibank.ResponsePojo;
...
public class GetUser extends GMIBankBaseUrl {
    ...
    public void get(){
        ...
        ResponsePojo expectedData = new ResponsePojo(110452,"Jasmine","Stehr","V",
                "marni.zboncak@yahoo.com","463-609-2097","1-112-497-0270",
                "16525","14387 Al Ridge5343 Bert Burgs","Waltermouth",
                "761-59-2911","2021-11-28T21:00:00Z",false,country,"California",
                user,accounts);

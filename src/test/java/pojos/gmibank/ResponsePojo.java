...
public class ResponsePojo implements Serializable {
	...
	public ResponsePojo(int id, String firstName, String lastName, String middleInitial, String email, String mobilePhoneNumber, String phoneNumber, String zipCode, String address, String city, String ssn, String createDate, boolean zelleEnrolled, CountryPojo country, String state, UserPojo user, List<Object> accounts) {
		this.id = id;

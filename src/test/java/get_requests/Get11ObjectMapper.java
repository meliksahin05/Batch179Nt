...
public class Get11ObjectMapper extends JsonPlaceHolderBaseUrl {
    ...
    public void get(){
       ...
       */
        ...
        //Do Assertions with Map class
        Map<String, Object> actualData2 = convertJsonToJava(response.asString(), HashMap.class);
        assertEquals(expectedDataMap.get("userId"),actualData2.get("userId"));
        assertEquals(expectedDataMap.get("title"),actualData2.get("title"));
        assertEquals(expectedDataMap.get("completed"),actualData2.get("completed"));
